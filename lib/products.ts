...
export const gemstoneSubcategories = [
  "ruby-manik","star-ruby","red-garnet","pearl","emerald-panna","red-carnelian","red-coral",
...
"white-zircon","white-sapphire","diamond","lemon-quartz","white-topaz","white-coral",
  ...
  "agates","keshi-pearl","basra-pearl","tigers-eye","blue-tourmaline","crystal",
  "sun-stone","green-beryl","green-agate","rose-quartz","lajward",
  "ametrine"
]
export const rudrakshaSubcategories = [
  "beads","mala","bracelet","trijuti","ganesh","gauri-shankar","garbh-gauri","1-to-21-mukhi"
]
...
},
{
  ...
  name: "Tiger's Eye (6 Carat)",
  category: "gemstones",
  subcategory: "tigers-eye",
  price: 500,
  images: ["/image/gemstones/tiger.jpg"],
  description: "Confidence and protection stone",
  specifications: [],
},
{
  slug: "basra-pearl-1",
  name: "Basra Pearl (Premium)",
  category: "gemstones",
...
// BEADS
{
  ...
  description: "Peace and stability",
  specifications: [],
},
...
// GARBH GAURI
{
  ...
  description: "Blessings for motherhood",
  specifications: [],
},
...

{
  ...
  category: "bracelets",
  price: 899,
  images: ["/image/bracelets/labradorite.jpg"],
  description: "Enhances intuition and protection.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 799,
  images: ["/image/bracelets/serpentine.jpg"],
  description: "Healing and detox energy.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 799,
  images: ["/image/bracelets/rose-quartz.jpg"],
  description: "Love and emotional healing.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 699,
  images: ["/image/bracelets/red-jasper.jpg"],
  description: "Grounding and stability.",
  specifications: [],
},
{
  slug: "pyrite-bracelet-2",
  name: "Pyrite Bracelet",
  category: "bracelets",
  price: 999,
  images: ["/image/bracelets/pyrite.jpg"],
  description: "Money and wealth attraction.",
  specifications: [],
},
{
  slug: "malachite-bracelet",
  name: "Malachite Bracelet",
  category: "bracelets",
  price: 899,
  images: ["/image/bracelets/malachite.jpg"],
  description: "Protection and transformation.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 899,
  images: ["/image/bracelets/lapis.jpg"],
  description: "Wisdom and truth.",
  specifications: [],
},
{
  slug: "amethyst-bracelet-2",
  name: "Amethyst Bracelet",
  category: "bracelets",
  price: 799,
  images: ["/image/bracelets/amethyst.jpg"],
  description: "Calmness and spirituality.",
  specifications: [],
},
{
  slug: "green-aventurine-bracelet-2",
  name: "Green Aventurine Bracelet",
  category: "bracelets",
  price: 699,
  images: ["/image/bracelets/aventurine.jpg"],
  description: "Luck and prosperity.",
  specifications: [],
},
{
  slug: "black-agate-bracelet",
  name: "Black Agate Bracelet",
  category: "bracelets",
  price: 699,
  images: ["/image/bracelets/black-agate.jpg"],
  description: "Protection from negativity.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 999,
  images: ["/image/bracelets/aquamarine.jpg"],
...
},
{
  ...
  category: "bracelets",
  price: 999,
  images: ["/image/bracelets/triple-protection.jpg"],
  description: "Protection with 3 powerful stones.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 599,
  images: ["/image/bracelets/evil-eye.jpg"],
  description: "Protects from evil eye.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 699,
  images: ["/image/bracelets/howlite.jpg"],
  description: "Calmness and stress relief.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 899,
  images: ["/image/bracelets/jade.jpg"],
  description: "Harmony and luck.",
  specifications: [],
},
{
  slug: "lava-stone-bracelet-2",
  name: "Lava Stone Bracelet",
  category: "bracelets",
  price: 599,
  images: ["/image/bracelets/lava.jpg"],
  description: "Grounding energy.",
  specifications: [],
},
{
  slug: "moonstone-bracelet-2",
  name: "Moonstone Bracelet",
  category: "bracelets",
  price: 899,
  images: ["/image/bracelets/moonstone.jpg"],
  description: "Emotional balance.",
  specifications: [],
},
{
  slug: "peridot-bracelet",
  name: "Peridot Bracelet",
  category: "bracelets",
  price: 899,
  images: ["/image/bracelets/peridot.jpg"],
  description: "Positivity and growth.",
  specifications: [],
},
{
  slug: "black-obsidian-bracelet",
  name: "Black Obsidian Bracelet",
  category: "bracelets",
  price: 799,
  images: ["/image/bracelets/obsidian.jpg"],
  description: "Strong protection stone.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 799,
  images: ["/image/bracelets/smoky.jpg"],
...
},
{
  ...
  category: "bracelets",
  price: 699,
  images: ["/image/bracelets/clear-quartz.jpg"],
  description: "Amplifies energy.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 899,
  images: ["/image/bracelets/7chakra.jpg"],
  description: "Balances all chakras.",
  specifications: [],
},
{
  slug: "rudraksha-bracelet-2",
  name: "Rudraksha Bracelet",
  category: "bracelets",
  price: 699,
  images: ["/image/bracelets/rudraksha.jpg"],
  description: "Spiritual protection.",
  specifications: [],
},
{
  slug: "citrine-bracelet-2",
  name: "Yellow Citrine Bracelet",
  category: "bracelets",
  price: 899,
  images: ["/image/bracelets/citrine.jpg"],
  description: "Wealth and success.",
  specifications: [],
},
{
  ...
  category: "bracelets",
  price: 799,
  images: ["/image/bracelets/hakik.jpg"],
...
},
{
  ...
  category: "bracelets",
  price: 499,
  images: ["/image/bracelets/sandalwood.jpg"],
  description: "Calmness and spiritual focus.",
  specifications: [],
},
...
//vastu section
{
  ...
  name: "Stainless Steel Vastu Strip",
  category: "vastu",
  subcategory: "vastu-strip",
  price: 399,
  images: ["/image/vastu/strip1.jpg"],
  description: "Balances energy flow.",
  specifications: [],
},
{
  slug: "copper-vastu-strip",
  name: "Copper Vastu Strip",
  category: "vastu",
  subcategory: "vastu-strip",
  price: 499,
  images: ["/image/vastu/strip2.jpg"],
  description: "Removes vastu defects.",
  specifications: [],
},
{
  slug: "brass-vastu-strip",
  name: "Brass Vastu Strip",
  category: "vastu",
  subcategory: "vastu-strip",
  price: 499,
  images: ["/image/vastu/strip3.jpg"],
  description: "Energy balancing strip.",
  specifications: [],
},
{
  slug: "five-metal-strip",
  name: "5 Metal Vastu Strip",
  category: "vastu",
  subcategory: "vastu-strip",
  price: 699,
  images: ["/image/vastu/strip4.jpg"],
  description: "Multi-metal vastu correction.",
  specifications: [],
},
//pyramid
{
  ...
  subcategory: "pyramid",
  price: 899,
  images: ["/image/vastu/pyramid1.jpg"],
  description: "Wealth attracting pyramid.",
  specifications: [],
},
{
  ...
  subcategory: "pyramid",
  price: 799,
  images: ["/image/vastu/pyramid2.jpg"],
  description: "Spiritual healing pyramid.",
  specifications: [],
},
{
  slug: "clear-quartz-pyramid",
  name: "Clear Quartz Pyramid",
  category: "vastu",
  subcategory: "pyramid",
  price: 699,
  images: ["/image/vastu/pyramid3.jpg"],
  description: "Energy amplifier.",
  specifications: [],
},
{
  slug: "green-aventurine-pyramid",
  name: "Green Aventurine Pyramid",
  category: "vastu",
  subcategory: "pyramid",
  price: 699,
  images: ["/image/vastu/pyramid4.jpg"],
  description: "Luck and prosperity.",
  specifications: [],
},
{
  slug: "nine-pyramid-strip",
  name: "9 Pyramid Strip",
  category: "vastu",
  subcategory: "pyramid",
  price: 599,
  images: ["/image/vastu/pyramid5.jpg"],
  description: "Vastu correction strip.",
  specifications: [],
},
{
  slug: "81-pyramid-strip",
  name: "81 Pyramid Strip",
  category: "vastu",
  subcategory: "pyramid",
  price: 999,
  images: ["/image/vastu/pyramid6.jpg"],
  description: "Advanced vastu correction.",
  specifications: [],
}, 
//tree
{
  ...
  subcategory: "tree",
  price: 899,
  images: ["/image/vastu/tree1.jpg"],
  description: "Spiritual energy tree.",
  specifications: [],
},
{
  slug: "pyrite-tree",
  ...
  subcategory: "tree",
  price: 999,
  images: ["/image/vastu/tree2.jpg"],
  description: "Wealth attracting tree.",
  specifications: [],
},
{
  slug: "seven-chakra-tree",
  name: "7 Chakra Tree",
  category: "vastu",
  subcategory: "tree",
  price: 899,
  images: ["/image/vastu/tree3.jpg"],
  description: "Balances all chakras.",
  specifications: [],
},
{
  slug: "green-aventurine-tree",
  name: "Green Aventurine Tree",
  category: "vastu",
  subcategory: "tree",
  price: 799,
  images: ["/image/vastu/tree4.jpg"],
  description: "Brings luck.",
  specifications: [],
},
{
  slug: "black-obsidian-tree",
  name: "Black Obsidian Tree",
  category: "vastu",
  subcategory: "tree",
  price: 899,
  images: ["/image/vastu/tree5.jpg"],
  description: "Protection tree.",
  specifications: [],
},
//bagua 
{
  slug: "bagua-mirror",
  name: "Bagua / Pakua Mirror",
  category: "vastu",
  subcategory: "bagua-mirror",
  price: 699,
  images: ["/image/vastu/mirror.jpg"],
  description: "Protects from negative energy.",
  specifications: [],
},
//wind chimes
{
  slug: "wind-chime-basic",
  name: "Wind Chime",
  category: "vastu",
  subcategory: "wind-chimes",
  price: 599,
  images: ["/image/vastu/chime1.jpg"],
  description: "Brings harmony.",
  specifications: [],
},
{
  slug: "copper-wind-chime",
  name: "Copper Wind Chime",
  category: "vastu",
  subcategory: "wind-chimes",
  price: 799,
  images: ["/image/vastu/chime2.jpg"],
  description: "Enhances positive energy.",
  specifications: [],
},
{
  slug: "evil-eye-wind-chime",
  name: "Evil Eye Wind Chime",
  category: "vastu",
  subcategory: "wind-chimes",
  price: 699,
  images: ["/image/vastu/chime3.jpg"],
...
// 🔵 MALA (DIRECT CATEGORY - NO SUBCATEGORY)
{
  ...
  description: "Spiritual mala for meditation",
  specifications: [],
},
{
  slug: "karungali-mala",
  ...
  description: "Protective energy mala",
  specifications: [],
},
{
  ...
  category: "mala",
  price: 1199,
  images: ["/image/mala/silver-karungali.jpg"],
  description: "Premium coated karungali mala",
  specifications: [],
},
{
  slug: "karungali-rudraksha-mala",
  name: "Karungali with Rudraksha Mala",
  category: "mala",
  price: 1299,
  images: ["/image/mala/karungali-rudraksha.jpg"],
  description: "Combination mala for protection",
  specifications: [],
},
{
  slug: "agate-mala",
  ...
  category: "mala",
  price: 799,
  images: ["/image/mala/agate.jpg"],
  description: "Balance and grounding energy",
  specifications: [],
},
{
  slug: "vaijayanti-mala",
  name: "Vaijayanti Mala",
  category: "mala",
  price: 699,
  images: ["/image/mala/vaijayanti.jpg"],
  description: "Sacred mala for Lord Vishnu",
  specifications: [],
},
{
  slug: "tulasi-mala",
  ...
  description: "Holy basil mala for devotion",
  specifications: [],
},
{
  slug: "amethyst-mala",
  ...
  category: "mala",
  price: 999,
  images: ["/image/mala/amethyst.jpg"],
  description: "Spiritual protection mala",
  specifications: [],
},
{
  slug: "pearl-mala",
  ...
  category: "mala",
  price: 1499,
  images: ["/image/mala/pearl.jpg"],
  description: "Calming and soothing mala",
  specifications: [],
},
{
  slug: "moonstone-mala",
  ...
  category: "mala",
  price: 1199,
  images: ["/image/mala/moonstone.jpg"],
  description: "Emotional balance mala",
  specifications: [],
},
{
  ...
  category: "mala",
  price: 1399,
  images: ["/image/mala/lapis.jpg"],
  description: "Wisdom and truth stone mala",
  specifications: [],
},
{
  slug: "garnet-mala",
  ...
  category: "mala",
  price: 999,
  images: ["/image/mala/garnet.jpg"],
  description: "Energy and vitality mala",
  specifications: [],
},
{
  slug: "spatik-mala",
  name: "Spatik (Crystal) Mala",
  category: "mala",
  price: 899,
  images: ["/image/mala/spatik.jpg"],
  description: "Cooling and healing crystal mala",
  specifications: [],
},
{
  ...
  description: "Calming meditation mala",
  specifications: [],
},
{
  slug: "tiger-eye-mala",
  ...
  category: "mala",
  price: 999,
  images: ["/image/mala/tiger.jpg"],
  description: "Confidence and strength mala",
  specifications: [],
},
// 🌿 HERBS
{
  ...
  description: "Premium black sandalwood",
  specifications: [],
},
{
  slug: "ganga-jal",
...
},
{
  ...
  description: "Pure red sandalwood",
  specifications: [],
},
{
  slug: "gugul-dhoop",
  ...
  category: "herbs",
  price: 249,
  images: ["/image/herbs/4.jpg"],
  description: "Natural gugul incense",
  specifications: [],
},
{
  slug: "jaiphal",
  ...
  category: "herbs",
  price: 199,
  images: ["/image/herbs/5.jpg"],
  description: "Pure jaiphal for rituals",
  specifications: [],
},
{
  slug: "kashmiri-kesar",
...
},
{
  ...
  category: "herbs",
  price: 149,
  images: ["/image/herbs/7.jpg"],
  description: "Used in pooja rituals",
  specifications: [],
},
{
  slug: "ajmoda",
...
},
{
  ...
  category: "herbs",
  price: 199,
  images: ["/image/herbs/9.jpg"],
  description: "Traditional healing root",
  specifications: [],
},
...
{
  slug: "gold-yantra",
  name: "Gold Colour Metal Yantra",
  category: "yantras",
  subcategory: "gold-metal",
  price: 999,
  images: ["/image/yantras/gold.jpg"],
  description: "Premium gold finish yantra",
  specifications: [],
},
{
  slug: "gold-yantra-frame",
  name: "Gold Metal Yantra (With Frame)",
  category: "yantras",
  subcategory: "gold-metal-frame",
  price: 1299,
  images: ["/image/yantras/gold-frame.jpg"],
  description: "Framed gold yantra",
  specifications: [],
},
{
  slug: "brass-yantra",
  name: "Brass Yantra Without Frame",
  category: "yantras",
  subcategory: "brass-without-frame",
  price: 799,
  images: ["/image/yantras/brass.jpg"],
  description: "Pure brass yantra",
  specifications: [],
},
{
  slug: "brass-yantra-frame",
  name: "Brass Yantra With Frame",
  category: "yantras",
  subcategory: "brass-with-frame",
  price: 1099,
  images: ["/image/yantras/brass-frame.jpg"],
  description: "Framed brass yantra",
  specifications: [],
},
{
  slug: "copper-yantra-frame",
  name: "Copper Yantra With Frame",
  category: "yantras",
  subcategory: "copper-with-frame",
  price: 999,
  images: ["/image/yantras/copper-frame.jpg"],
  description: "Copper yantra framed",
  specifications: [],
},
{
  slug: "copper-yantra",
  name: "Copper Yantra Without Frame",
  category: "yantras",
  subcategory: "copper-without-frame",
  price: 799,
  images: ["/image/yantras/copper.jpg"],
  description: "Copper yantra",
  specifications: [],
},
]