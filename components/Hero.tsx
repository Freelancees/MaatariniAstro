...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      {/* 🌕 SOFT GLOW */}
      <div className="absolute inset-0 flex items-center justify-center z-0">
        <div className="w-[500px] h-[500px] bg-white rounded-full blur-[150px] opacity-20" />
      </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <div className="mb-8 relative h-32 flex items-center justify-center"
              ...
              {heroTexts.map((text, index) => (
                <motion.h1
                  ...
                  animate={{
                    opacity: currentTextIndex === index ? 1 : 0,
                    x: currentTextIndex === index ? 0 : -80,
                    filter: currentTextIndex === index ? "blur(0px)" : "blur(10px)",
                  }}
                  transition={{
                    duration: 0.9,
                    ease: [0.22, 1, 0.36, 1],
                  }}
                  className="absolute text-4xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight leading-tight drop-shadow-[0_5px_20px_rgba(0,0,0,0.7)]"
                >
                  {text}
                </motion.h1>
              ))}
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-white/80 mb-12 italic"
              style={{ textShadow: "0px 4px 8px rgba(0,0,0,0.7)" }}>
              Discover Your Destiny Through Ancient Wisdom
            </motion.p>
            ...
            >
              ...
              <button className="px-10 py-4 bg-yellow-400 text-black rounded-full font-semibold shadow-xl hover:scale-105 hover:bg-yellow-300 transition-all duration-300">
                Book Consultation
              </button>

              <button className="px-10 py-4 border border-white/60 text-white rounded-full font-semibold hover:bg-white hover:text-black transition-all duration-300 backdrop-blur-md">
                Learn More
              </button>
